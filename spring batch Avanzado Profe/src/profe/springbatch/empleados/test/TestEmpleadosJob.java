...
public class TestEmpleadosJob {
	...
	@Resource(name="transformaEmpleadosEnProductos")
	private Job jobTEeP;
	...
	private void go() throws Exception {
		...
		//this.muestraEmpleadosFromDb();
		//this.transformaEmpEnProd();
	}
	...
	private void transformaEmpEnProd() throws Exception {
		jobLauncher.run(jobTEeP, new JobParametersBuilder()
				.addLong("timestamp", System.currentTimeMillis())
				.toJobParameters());
	}
