...
public class TestEmpleadoJob {
	...
	public static void main(String[] args) throws Exception {
		...
		//1º job-context-empleado_3_pasos.xml 2º job-empleado-wrapper_context.xml y 3ºjob-context-emplprod.xml 4ºjob-context-empleados.xml
		ApplicationContext context = new ClassPathXmlApplicationContext(new String[] { "job-context-empleado_3_pasos.xml" });
